...
public class CodeWriter {
    ...
    static{
         ...
         * @R13
         * M=D
         * <<push R13 0>> [need into asm] [PUSH_SEGMENT_ADDR]
         * <<push LCL 0>> [PUSH_SEGMENT_ADDR]
         * <<push ARG 0>> [PUSH_SEGMENT_ADDR]
         * <<push THIS 0>> [PUSH_SEGMENT_ADDR]
         * <<push THAT 0>> [PUSH_SEGMENT_ADDR]
         * <<push SP 0>> [PUSH_SEGMENT_ADDR]
         * <<push constant <num>>>
         * <<sub>>
         * <<pop ARG 0>> [POP_SEGMENT_ADDR]
         * @SP
         * D=M
         * @LCL
         * M=D
